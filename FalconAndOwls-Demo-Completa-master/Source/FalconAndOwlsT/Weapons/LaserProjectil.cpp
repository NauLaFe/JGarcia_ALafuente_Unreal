...
ALaserProjectil::ALaserProjectil()
{
	...
	Projectil->OnComponentBeginOverlap.AddDynamic(this, &ALaserProjectil::ProjectilHit);
}
...
//void ALaserProjectil::ProjectilHit(AActor* OverlappedActor, AActor* OtherActor)
{
	...
	//MYLOG("DESTROY")
	AAsteroidsField *asteroids = Cast<AAsteroidsField>(OtherActor);
	if (asteroids)
	{
